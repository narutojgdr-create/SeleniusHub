...
return function(queryPoint: Vector2, gui: ImageLabel | ImageButton): { number }
	...
	imageColor[1] = imageColor[1] * multColor.R
	imageColor[2] = imageColor[2] * multColor.G
	imageColor[3] = imageColor[3] * multColor.B
	imageColor[4] = imageColor[4] * (1 - gui.ImageTransparency)
