			...
			for colorChannel = 0, channels do
				...
				if radiusIsTooWide then
					...
					for _ = 1, imageWidth do
						average = average + pixelData[targetIndex]
						targetIndex = targetIndex + 4
					end
					average = average / imageWidth
				...
				for i = 1, blurRadius do
					accumulator = accumulator + pixelData[targetIndex + i * 4]
				end
				-- Move through each pixel in the row
				for i = 0, blurRadius do
					accumulator = accumulator + pixelData[rightIndex] - pixelData[targetIndex + i * 4]
				...
				for _ = blurRadius + 1, imageWidth - blurRadius - 1 do
					accumulator = accumulator + pixelData[rightIndex] - pixelData[leftIndex]
					pixelData[targetIndex] = accumulator * inverseArea
				...
				for _ = imageWidth - blurRadius, imageWidth - 1 do
					accumulator = accumulator + lastValue - pixelData[leftIndex]
					pixelData[targetIndex] = accumulator * inverseArea
					leftIndex = leftIndex + 4
					targetIndex = targetIndex + 4
				end
			...
			for colorChannel = 0, channels do
				...
				if radiusIsTooTall then
					...
					for _ = 1, imageHeight do
						average = average + pixelData[targetIndex]
						targetIndex = targetIndex + widthTimesFour
					end
					average = average / imageHeight
					targetIndex = leftIndex
					for _ = 1, imageHeight do
						pixelData[targetIndex] = average
						targetIndex = targetIndex + widthTimesFour
				...
				for i = 1, blurRadius do
					accumulator = accumulator + pixelData[targetIndex + i * widthTimesFour]
				end
				-- Apply the blur vertically down the column
				for i = 0, blurRadius do
					accumulator = accumulator + pixelData[rightIndex] - pixelData[targetIndex + i * widthTimesFour]
					pixelData[targetIndex] = accumulator * inverseArea
					rightIndex = rightIndex + widthTimesFour
					targetIndex = targetIndex + widthTimesFour
				end
				...
				for _ = blurRadius + 1, imageHeight - blurRadius - 1 do
					accumulator = accumulator + pixelData[rightIndex] - pixelData[leftIndex]
					pixelData[targetIndex] = accumulator * inverseArea
					leftIndex = leftIndex + widthTimesFour
					rightIndex = rightIndex + widthTimesFour
					targetIndex = targetIndex + widthTimesFour
				end
