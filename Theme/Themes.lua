...
local Themes = {
	Midnight = {
		...
		AcrylicTransparency = 0.14,
		PanelTransparency = 0.16,
		SurfaceTransparency = 0.12,
		ControlTransparency = 0.34,
		NotificationTransparency = 0.18,
		CardTransparency = 0.16,
		PageTransparency = 0.64,
		FloatingButtonTransparency = 0.54,
		SeparatorTransparency = 0.49,
